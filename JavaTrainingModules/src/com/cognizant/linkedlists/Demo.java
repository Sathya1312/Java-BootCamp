...
public class Demo {
	...
	public static void main(String[] args){
		...
		linkedList.add(1, "AliceSpring");
		printList(linkedList);
		
		linkedList.remove(4);*/
		printList(linkedList);
		
		addInOrder(linkedList, "AliceSpring");
		addInOrder(linkedList, "Darwin");
		printList(linkedList);
	...
	private static void printList(LinkedList<String> linkedLists){
	...
	private static void visit(LinkedList cities){
		...
		if(cities.isEmpty()){
			System.out.println("No lists in the itenarary");						
		}else{
